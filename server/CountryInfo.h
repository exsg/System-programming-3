...
public:
    ...
    CountryInfo(string name, int worker_number) : name(name), worker_number(worker_number), nextCountryInfo(NULL) {
    ...
    static WorkerThread * getWorker(WorkerThread * workers, string country);
};
